...
import { ArrowRight, Store, LogIn, UserPlus } from "lucide-react";

export const Route = createFileRoute("/merchant-auth")({
  component: MerchantAuthPage,
});

function MerchantAuthPage() {
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-border/40 bg-background/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-md items-center gap-3 px-4 py-3">
          ...
          <h1 className="text-lg font-black text-foreground">أصحاب المتاجر</h1>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-md px-4 py-8">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h2 className="text-2xl font-black text-foreground">بوابة أصحاب المتاجر</h2>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1 text-right">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                لأصحاب المتاجر المعتمدين من الإدارة
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="flex-1 text-right">
              <p className="text-base font-black text-foreground">تقديم طلب انضمام</p>
              <p className="mt-0.5 text-xs text-muted-foreground">
                للراغبين في تسجيل متجر جديد على ثواني
              </p>
            </div>
          </Link>
        </div>
        ...
        <p className="mt-6 rounded-2xl bg-accent/10 p-4 text-center text-xs text-muted-foreground">
          سيتم مراجعة طلبك من قبل الإدارة. لن تتمكن من الدخول إلى لوحة التحكم
