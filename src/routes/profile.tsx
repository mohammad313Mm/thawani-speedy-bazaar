      ...
      <main className="mx-auto max-w-2xl space-y-4 px-4 py-4">
        <section className="flex items-center gap-4 rounded-3xl bg-gradient-warm p-5 text-white shadow-elegant">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-lg font-black">مرحباً بك</p>
            <p className="mt-0.5 text-xs opacity-90">
              سجل دخولك لتتبع طلباتك وحفظ عناوينك
            </p>
          </div>
          <button className="rounded-full bg-white px-4 py-2 text-xs font-black text-primary shadow-soft">
            دخول
          </button>
        </section>
        ...
        <button className="flex w-full items-center justify-center gap-2 rounded-2xl border border-destructive/30 bg-destructive/5 py-3.5 text-sm font-black text-destructive">
