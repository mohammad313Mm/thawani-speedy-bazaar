...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "الصافي — تسوق وتوصيل سريع في العراق" },
      {
        name: "description",
        content:
          "الصافي — منصة التسوق والتوصيل الأولى في العراق. مطاعم، بقالة، كوزمتك، وحلويات ومشروبات. كل ما تحتاجه مع الصافي.",
      },
      { property: "og:title", content: "الصافي — تسوق وتوصيل سريع في العراق" },
      {
        property: "og:description",
        content: "الصافي — منصة التسوق والتوصيل الأولى في العراق. مطاعم، بقالة، كوزمتك، وحلويات ومشروبات. كل ما تحتاجه مع الصافي.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "الصافي — تسوق وتوصيل سريع في العراق" },
      { name: "twitter:description", content: "الصافي — منصة التسوق والتوصيل الأولى في العراق. مطاعم، بقالة، كوزمتك، وحلويات ومشروبات. كل ما تحتاجه مع الصافي." },
